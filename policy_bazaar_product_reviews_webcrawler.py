...
# Dataframes
df_company_product_reviews = pd.DataFrame()
...
# Read all Sub Category URLs and collect names of companies which provide insurance in that category
...
for url in (review_url_list):
    ...
    df_company_product_reviews.to_csv('policy_bazaar_insurance_products_reviews.csv')